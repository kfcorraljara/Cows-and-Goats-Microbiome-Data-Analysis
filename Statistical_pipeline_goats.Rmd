---
title: "statisticl_pipeline_goats"
...
RNA_seq_chevres <- read.csv("BGI_chevres_RNA_seq.csv", row.names = 1)
head(RNA_seq_chevres,2)
colnames(RNA_seq_chevres) <- c("13035P1", "13035P2", "13035P3", "13035P4", "14100P1", "14100P2", "14100P3", "14100P4", "14188P1", "14188P2", "14188P3", "14188P4", "14201P1", "14201P2", "14201P3", "14201P4")
...
OTUs_chevres <- read.csv("OTUS_chevres.csv", row.names = NULL)
rownames(OTUs_chevres) <- make.names(OTUs_chevres[,1], unique = TRUE)
OTUs_chevres$X <- NULL
colnames(OTUs_chevres) <- c("13035P1", "13035P2", "13035P3", "13035P4", "14100P1", "14100P2", "14100P3", "14100P4", "14188P1", "14188P2", "14188P3", "14188P4", "14201P1", "14201P2", "14201P3", "14201P4")
head(OTUs_chevres,2)

#With the count matrix, OTUs_vaches, and the sample information, coldata, we can construct a DESeqDataSet:
dds_otus <- DESeqDataSetFromMatrix(countData = OTUs_chevres,
                              colData = coldata,
                              design = ~ condition)
...
#Selection of KEGGs and OTUs DE from the original dataframe. 
KEGGs_selection <- RNA_seq_chevres[ intersect(rownames(RNA_seq_chevres), rownames(selection_COS_CTL_DE)), ]
OTUs_selection <- OTUs_chevres[ intersect(rownames(OTUs_chevres), rownames(selection_COS_CTL_OTUs_DE)), ]

#Uploading of fermentation parameters dataframe. 
metabolites <- read.csv("metabolites_goats.csv", row.names = 1)
colnames(metabolites) <- c("13035P1", "13035P2", "13035P3", "13035P4", "14100P1", "14100P2", "14100P3", "14100P4", "14188P1", "14188P2", "14188P3", "14188P4", "14201P1", "14201P2", "14201P3", "14201P4")

#Union of three dataframes: KEGGs + OTUs + metabolites
...
kmeans <-kmeans(data_selection, 5, nstart = 1)
...
library(mixOmics)
CH4 <- read.csv("CH4_goats.csv", row.names = 1)
CH4_milk <- read.csv("CH4.milk_goats.csv", row.names = 1)
CH4_FPCM <- read.csv("CH4.FPMC_goats.csv", row.names = 1)
CH4_MSI <- read.csv("CH4.MSI_goats.csv", row.names = 1)
CH4_CO2 <- read.csv("CH4.CO2_goats.csv", row.names = 1)
...
tune.splls.MAE <- tune.spls(data_cluster_mixomic, CH4, test.keepX = list.keepX, validation = 'Mfold', folds = 5, nrepeat = 10, progressBar = FALSE, measure = 'MAE', ncomp=3)
...
write.csv(as.data.frame(output), file = "output_goats.csv")
